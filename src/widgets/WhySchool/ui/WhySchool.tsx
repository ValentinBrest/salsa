                    ...
                    <div className={cl.decr}>
                        ...
                        <Text align={TextAlign.CENTER}
                            text={<>Самое главное при выборе школы – это <b>преподаватели</b>. Мы определили Сальсу своим Делом и собираемся продвигать это танцевальное направление в нашем городе, ломать сложившиеся стереотипы, постоянно совершенствуясь в танце, продолжая углублять и делать всесторонними свои знания и методику преподавания. Мы готовы тратить на это все имеющееся у нас время. Поверьте, настоящая сальса этого достойна! <br/><br/> Мы танцуем сальсу более 10 лет, обучались у ведущих мировых танцоров сальсы. У нас за плечами множество изученных мастер-классов, поездок и выступлений.  Только в этом (2023) году мы успели побывать { !isVisible? '...' : ''} {!isVisible? '' : <>в качестве педагогов в г. Минске  <u>на фестивале Minsk Salsa All-Stars</u> от Salsa.Evolution, поучаствовали в <u>Сальса марафоне Mambolove</u> (г. Москва), <u>фестивале ESTO.FEST</u> (г. Санкт-Петербург). 
                                ...
                                <br/>Наша задача, как преподавателей, не только в том, чтобы вы научились получать удовольствие от танца (как в паре, так и соло), но еще больше в том, чтобы вы испытывали радость от осознания своего роста в танце и от того, что попали именно к нам в школу. <br/><br/>Представляем нашего преподавателя по женскому стилю в сальсе. <u>Мария Сервантес</u>. Начала свой танцевальный путь с художественной гимнастики, в которую пришла в 4 года и доросла до 2 взрослого разряда. Затем с отличием окончила «Детскую хореографическую школу им. Погодина г.Бреста». Имеет большой опыт сценических выступлений, участия в международных конкурсах и фестивалях, а также собственных хореографических постановок. Владеет классическим и народно-сценическим видами танцев. Также изучала современные танцы: контемп, хип-хоп, джаз-фанк, хай-хилз. Имеет опыт работы в театре танца.  Проходила обучение у топовых танцоров сальсы в @mambovirtualacademy. Прошла отбор в virtual team Татьяны Каннарсы. Победительница одного из челленджей Брэнды Ли. Мария продолжает развиваться сама и с радостью  делится приобретенным опытом со своими учениками. А имея вдобавок и высшее педагогическое образование, она максимально профессионально подходит к процессу обучения.</>}</>}
                        />
                    </div>
